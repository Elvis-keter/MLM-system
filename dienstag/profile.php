...
<section id="main-site">
    <div class="container py-5">
        <div class="row">
            <div class="col-4 offset-4 shadow py-4" id="sub-site">
                <div class="upload-profile-image d-flex justify-content-center pb-5">
                    <div class="text-center">
                        <img class="img rounded-circle" style="width: 200px; height: 200px;" src="<?php echo isset($user['profileImage']) ? $user['profileImage'] : './assets/profile/toshiba.png'; ?>" alt="">
                        <h4 class="py-3">
                            <?php
                ...
                <div class="user-info px-3">
                    <ul class="font-ubuntu navbar-nav">
                        ...
                        <li class="nav-link"><b>Tel No: </b><span><?php echo isset($user['tnumber']) ? $user['tnumber'] : ''; ?></span></li>
                    </ul>
                </div>
            </div>
        </div>
